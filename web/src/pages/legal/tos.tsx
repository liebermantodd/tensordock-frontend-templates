      ...
      <div className="container mx-auto px-4 sm:px-6 md:px-8 lg:px-12 py-8">
        ...
        <div className="space-y-6">
          ...
          <ul className="list-disc pl-5 space-y-2">
            <li>After account creation, you will use Blue Lobster Services in proper compliance with all laws, rules and regulations applicable to you.</li>
            <li>When a person over 18 years of age is the customer, using our Services adheres to giving us legal consent and agreeing to the prudential use of Blue Lobster Services in applicable jurisdictions.</li>
            <li>When a person creates an Account and uses Blue Lobster Services on behalf of an organized entity, they bind the entity they represent to this TOS and they agree to be legally bound by this TOS on the entity's behalf.</li>
          </ul>
          ...
          <ul className="list-disc pl-5 space-y-2">
            <li>All data uploaded by the Customer to Blue Lobster services and</li>
            <li>All data created by the Customer on Blue Lobster services.</li>
          </ul>

          <p><strong>"Covered Service"</strong> means:</p>
          <ul className="list-disc pl-5 space-y-2">
            <li>Instances in Multiple Regions.</li>
            <li>One Instance.</li>
          </ul>
          ...
          <h2>Default Payment Terms and Billing</h2>
          ...
          <h2>Deletion Upon Termination</h2>
          ...
          <h2>Incidents Involving Data</h2>

          <h3>Notification of an Incident</h3>
          ...
          <h3>Information on the Data Security Incident</h3>
          ...
          <h3>Blue Lobster's Lack of Assessment of Customer Data</h3>
          ...
          <h3>Blue Lobster Has No Acknowledgement of Fault</h3>
          ...
          <h2>Contact Us</h2>
          <p>If you have any inquiries regarding these Terms of Service, please feel free to contact us.</p>
